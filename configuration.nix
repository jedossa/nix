...

{
 ...
 environment.systemPackages = with pkgs; [
   coreutils dcfldd wget curl gnupg git htop emacs lsof vscode vlc
   openssh xz killall mkpasswd nox xclip ark file dnsutils protobuf
   openvpn nix-prefetch-git kgpg nix-index terminator openjdk zip unzip slack
   home-manager tmux tree arandr gitAndTools.gitflow docker-compose scala dotty
   sbt ammonite jetbrains.idea-community bloop meld slack-theme-black google-chrome
 ...
 users.users.yagami = {
   isNormalUser = true;
   home = "/home/yagami";
   extraGroups = [ "wheel" "networkmanager" "audio" "video" "docker" "plugdev" ]; # Enable  for the user.
 };
